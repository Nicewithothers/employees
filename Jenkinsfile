pipeline {
    environment {
        ...
        IMAGE_NAME = "nicewithothers/employees:${VERSION_NUMBER}"
        }
    ...
    stages {
        ...
        stage('Docker') {
            steps {
                ...
                sh "docker tag ${IMAGE_NAME} nicewithothers/employees_jenkins:latest"
                sh "docker push nicewithothers/employees_jenkins:latest"
            }
        }
    }
}